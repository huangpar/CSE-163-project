...
def merged_data(game_data: pd.DataFrame, twitch_data: pd.DataFrame, player = pd.DataFrame) -> pd.DataFrame:
    ...
    player[['month', 'year']] = player['Month_Year'].str.split(' ', expand=True)
